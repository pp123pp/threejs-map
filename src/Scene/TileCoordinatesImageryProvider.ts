...
// import { CesiumColor } from './CesiumColor.js';
...
/**
     ...
     */
const TileCoordinatesImageryProvider = function TileCoordinatesImageryProvider (options?: any) {
    options = defaultValue(options, defaultValue.EMPTY_OBJECT);

    this._tilingScheme = defined(options.tilingScheme)
        ? options.tilingScheme
        : new GeographicTilingScheme({ ellipsoid: options.ellipsoid });
    this._color = defaultValue(options.color, CesiumColor.RED);
...
/**
     ...
     */
TileCoordinatesImageryProvider.prototype.getTileCredits = function (x: any, y: any, level: any) {
    return undefined;
};
...
/**
     ...
     */
TileCoordinatesImageryProvider.prototype.pickFeatures = function (x: any, y: any, level: any, longitude: any, latitude: any) {
    return undefined;
};
