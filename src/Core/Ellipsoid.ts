...
function initialize (ellipsoid:Ellipsoid, x = 0.0, y = 0.0, z = 0.0) {
   ...
   * @private
   */
   function gaussLegendreQuadrature(a: number, b: number, func: any): number {
...
class Ellipsoid {
    _radii: Cartesian3 | undefined;
    _radiiSquared: Cartesian3 | undefined;
    _radiiToTheFourth: Cartesian3 | undefined;
    _oneOverRadii: Cartesian3 | undefined;
    _oneOverRadiiSquared: Cartesian3 | undefined;
    _minimumRadius: number | undefined;
    _maximumRadius: number | undefined;
    _centerToleranceSquared: number | undefined;
 ...
 */
 static clone (ellipsoid:Ellipsoid, result?:Ellipsoid) {
   ...
   */
  static fromCartesian3 (cartesian = Cartesian3.ZERO, result = new Ellipsoid()) {
 ...
 static pack (value:Ellipsoid, array: number[], startingIndex=0.0) {
  ...
  cartesianToCartographic (cartesian:Cartesian3, result?:Cartographic):Cartographic | undefined {
    ...
    var n = this.geodeticSurfaceNormal(p, cartesianToCartographicN) as Cartesian3;
